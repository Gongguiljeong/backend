...
public enum ExceptionCode {
    ...
    NOT_FOUND(0003, HttpStatus.NOT_FOUND, "찾을 수 없습니다."),
    BAD_REQUEST(0004, HttpStatus.BAD_REQUEST, "잘못된 요청입니다."),
    INTERNAL_SERVER_ERROR(0005, HttpStatus.INTERNAL_SERVER_ERROR, "서버에 오류가 발생했습니다."),
